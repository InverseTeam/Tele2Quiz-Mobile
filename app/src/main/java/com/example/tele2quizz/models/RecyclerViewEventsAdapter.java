...
public class RecyclerViewEventsAdapter extends RecyclerView.Adapter<RecyclerViewEventsAdapter.ViewHolder> implements RecyclerViewInterface{

    private List<ResponseModelClass> list;
    private Context context;
    private final RecyclerViewInterface recyclerViewInterface;

    public RecyclerViewEventsAdapter(List<ResponseModelClass> list, Context context, RecyclerViewInterface recyclerViewInterface) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.textAttemptEvents.setText("3 из 3 попытки");
        holder.textCountEvents.setText(String.valueOf(list.get(position).getQuestionPoints()) + " баллов");
    }
